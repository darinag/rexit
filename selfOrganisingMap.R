...
main<-function(){
  ...
  # # # # # # # # # # # # # # # # # # # # # EUROPE  # # # # # # # # # # # # # # # # # # # # # # # # # # # #  # # # # # # # # # # # # # # # # # # # # #
  europe <- subset(loans, (Region=="Eastern Europe" | Region=="Western Europe"))
  europe <- subset(europe, (Attack_Type != 'Unknown'))
